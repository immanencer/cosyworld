...
class OllamaService {
     ...
     * @property {string} [model='llama3.1:8b-instruct-q3_K_M'] - The base model to use
     ...
     */
    async updateConfig({ baseModel = 'llama3.1:8b-instruct-q3_K_M', systemPrompt = this.systemPrompt }) {
        const modelfile = `FROM llama3.1:8b-instruct-q3_K_M\nSYSTEM "${systemPrompt}"`
