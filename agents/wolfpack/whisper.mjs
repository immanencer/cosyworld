...
class Whisper extends DiscordBot {
    ...
    async on_login() {
        ...
        const memory = await ai.currentService.raw_chat({model: 'llama3.1:8b-instruct-q3_K_M', messages: [
            { role, content },
            {
    ...
    async on_message(message) {
        ...
        const respond = await ai.currentService.raw_chat({ model: 'llama3.1:8b-instruct-q3_K_M',messages: [
